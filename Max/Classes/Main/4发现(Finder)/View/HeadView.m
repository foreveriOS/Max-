...
- (instancetype)initWithFrame:(CGRect)frame firstButtonName:(NSString *)firstName lastButtonName:(NSString *)lastName {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        commentButton.frame = CGRectMake(0, 0, 70, 20);
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeButtonSelectWithNoti:) name:@"headView" object:nil];
        
        
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeButtonSelectWithNoti:) name:@"newsHeadView" object:nil];
    }
...
- (void)changeActionWithIndex:(UIButton *)button {
    ...
    [center postNotificationName:@"scrollView" object:self userInfo:userInfo];
}
...
- (void)dealloc {
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"headView" object:nil];
    
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"newsHeadView" object:nil];
}
